...
export class AuditController {
  ...
  @ApiOperation({ summary: 'Criar snapshot de configurações para PGA', description: 'Cria snapshot das configurações ativas para um PGA' })
  @ApiParam({ name: 'pgaId', type: 'number', description: 'ID do PGA' })
  @ApiBody({ schema: { type: 'object', properties: { ano: { type: 'number' }, usuarioId: { type: 'number' } } } })
  ...
  @ApiOperation({ summary: 'Buscar configurações por ano', description: 'Retorna configurações ativas para um ano específico' })
  @ApiParam({ name: 'ano', type: 'number', description: 'Ano das configurações' })
  ...
  @ApiOperation({ summary: 'Buscar situações problema por ano', description: 'Retorna situações problema ativas para um ano' })
  @ApiParam({ name: 'ano', type: 'number', description: 'Ano das situações problema' })
  @ApiResponse({ status: 200, description: 'Situações problema retornadas com sucesso' })
  ...
  @ApiOperation({ summary: 'Buscar eixos temáticos por ano', description: 'Retorna eixos temáticos ativos para um ano' })
  @ApiParam({ name: 'ano', type: 'number', description: 'Ano dos eixos temáticos' })
  @ApiResponse({ status: 200, description: 'Eixos temáticos retornados com sucesso' })
  ...
  @ApiOperation({ summary: 'Buscar pessoas por ano', description: 'Retorna pessoas ativas para um ano específico' })
  ...
  @Post('log')
  @ApiOperation({ summary: 'Criar log de auditoria', description: 'Cria novo registro de auditoria' })
  ...
  @ApiOperation({ summary: 'Buscar histórico de auditoria', description: 'Retorna histórico de mudanças de um registro' })
  @ApiParam({ name: 'tabela', type: 'string', description: 'Nome da tabela' })
  @ApiParam({ name: 'registroId', type: 'number', description: 'ID do registro' })
  ...
  @Get('year/:ano')
  @ApiOperation({ summary: 'Buscar auditoria por ano', description: 'Retorna logs de auditoria de um ano específico' })
  ...
  @Get('table/:tabela')
  @ApiOperation({ summary: 'Buscar auditoria por tabela', description: 'Retorna logs de auditoria de uma tabela específica' })
  @ApiParam({ name: 'tabela', type: 'string', description: 'Nome da tabela' })
  @ApiResponse({ status: 200, description: 'Logs retornados com sucesso' })
  ...
  @ApiOperation({ summary: 'Relatório de mudanças por ano', description: 'Gera relatório de mudanças ocorridas em um ano' })
  ...
  @Get('report/summary')
  @ApiOperation({ summary: 'Resumo de auditoria', description: 'Retorna resumo estatístico da auditoria por período' })
  @ApiQuery({ name: 'startYear', type: 'string', required: false, description: 'Ano de início' })
  @ApiQuery({ name: 'endYear', type: 'string', required: false, description: 'Ano de fim' })
  ...
  @Get('table/:tableName')
  @ApiOperation({ summary: 'Histórico de tabela', description: 'Retorna histórico de mudanças de uma tabela' })
  @ApiParam({ name: 'tableName', type: 'string', description: 'Nome da tabela' })
  @ApiQuery({ name: 'year', type: 'string', required: false, description: 'Ano para filtrar' })
  @ApiResponse({ status: 200, description: 'Histórico retornado com sucesso' })
