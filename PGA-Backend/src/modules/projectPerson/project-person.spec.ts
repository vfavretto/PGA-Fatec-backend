...
describe('CreateProjectPersonService', () => {
  ...
  beforeEach(() => { jest.clearAllMocks(); service = new CreateProjectPersonService(mockRepo as any); });

  it('deve criar e retornar a associação projeto-pessoa', async () => {
    mockRepo.create.mockResolvedValue({ projeto_pessoa_id: 1 });
    expect(await service.execute({ pessoa_id: 1, acao_projeto_id: 1 } as any)).toEqual({ projeto_pessoa_id: 1 });
  });
});

describe('FindAllProjectPersonService', () => {
  let service: FindAllProjectPersonService;
  beforeEach(() => { jest.clearAllMocks(); service = new FindAllProjectPersonService(mockRepo as any); });
...
describe('FindOneProjectPersonService', () => {
  ...
  beforeEach(() => { jest.clearAllMocks(); service = new FindOneProjectPersonService(mockRepo as any); });
...
describe('UpdateProjectPersonService', () => {
  ...
  beforeEach(() => { jest.clearAllMocks(); service = new UpdateProjectPersonService(mockRepo as any); });
...
describe('DeleteProjectPersonService', () => {
  ...
  beforeEach(() => { jest.clearAllMocks(); service = new DeleteProjectPersonService(mockRepo as any); });
