...
export class ProjectPersonController {
  ...
  @Post()
  @ApiOperation({
    summary: 'Vincular pessoa ao projeto',
    description: 'Cria um novo vínculo entre pessoa e projeto',
  })
  ...
  @Get()
  @ApiOperation({
    summary: 'Listar vínculos projeto-pessoa',
    description: 'Retorna lista de todos os vínculos entre projetos e pessoas',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Retorna dados de um vínculo específico entre projeto e pessoa',
  })
  @ApiParam({
    name: 'id',
    type: 'number',
    description: 'ID do vínculo projeto-pessoa',
  })
  ...
  @Put(':id')
  @ApiOperation({
    summary: 'Atualizar vínculo projeto-pessoa',
    description: 'Atualiza dados de um vínculo específico',
  })
  @ApiParam({
    name: 'id',
    type: 'number',
  ...
  @Delete(':id')
  @ApiOperation({
    summary: 'Remover vínculo projeto-pessoa',
    description: 'Remove um vínculo entre projeto e pessoa',
  })
  @ApiParam({
    name: 'id',
    type: 'number',
