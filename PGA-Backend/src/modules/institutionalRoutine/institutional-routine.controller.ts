...
export class InstitutionalRoutineController {
  ...
  @Post()
  @ApiOperation({
    summary: 'Criar rotina institucional',
    description: 'Cria uma nova rotina institucional no sistema',
  })
  @ApiBody({ type: CreateInstitutionalRoutineDto })
  @ApiResponse({
    status: 201,
    description: 'Rotina institucional criada com sucesso',
  })
  ...
  @Get()
  @ApiOperation({
    summary: 'Listar rotinas institucionais',
    description: 'Retorna lista de todas as rotinas institucionais',
  })
  @ApiResponse({
    status: 200,
    description: 'Lista de rotinas institucionais retornada com sucesso',
  })
  ...
  @Get(':id')
  @ApiOperation({
    summary: 'Buscar rotina institucional por ID',
    description: 'Retorna dados de uma rotina institucional específica',
  })
  @ApiParam({
    name: 'id',
    type: 'number',
  ...
  @ApiResponse({
    status: 200,
    description: 'Rotina institucional encontrada com sucesso',
  })
  @ApiResponse({
    status: 404,
    description: 'Rotina institucional não encontrada',
  })
  ...
  @Put(':id')
  @ApiOperation({
    summary: 'Atualizar rotina institucional',
    description: 'Atualiza dados de uma rotina institucional específica',
  })
  @ApiParam({
    name: 'id',
    type: 'number',
  ...
  @ApiResponse({
    status: 200,
    description: 'Rotina institucional atualizada com sucesso',
  })
  @ApiResponse({
    status: 404,
    description: 'Rotina institucional não encontrada',
  ...
  @Delete(':id')
  @ApiOperation({
    summary: 'Excluir rotina institucional',
    description: 'Remove uma rotina institucional do sistema',
  })
  @ApiParam({
    name: 'id',
    type: 'number',
  ...
  @ApiResponse({
    status: 200,
    description: 'Rotina institucional excluída com sucesso',
  })
  @ApiResponse({
    status: 404,
    description: 'Rotina institucional não encontrada',
