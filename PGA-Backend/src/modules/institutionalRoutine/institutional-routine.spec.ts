...
describe('CreateInstitutionalRoutineService', () => {
  ...
  beforeEach(() => { jest.clearAllMocks(); service = new CreateInstitutionalRoutineService(mockRepo as any); });

  it('deve criar e retornar a rotina institucional', async () => {
    mockRepo.create.mockResolvedValue({ rotina_id: 1 });
    expect(await service.execute({ descricao: 'Rotina 1' } as any)).toEqual({ rotina_id: 1 });
  });
});

describe('FindAllInstitutionalRoutineService', () => {
  let service: FindAllInstitutionalRoutineService;
  beforeEach(() => { jest.clearAllMocks(); service = new FindAllInstitutionalRoutineService(mockRepo as any); });
...
describe('FindOneInstitutionalRoutineService', () => {
  ...
  beforeEach(() => { jest.clearAllMocks(); service = new FindOneInstitutionalRoutineService(mockRepo as any); });
...
describe('UpdateInstitutionalRoutineService', () => {
  ...
  beforeEach(() => { jest.clearAllMocks(); service = new UpdateInstitutionalRoutineService(mockRepo as any); });
...
describe('DeleteInstitutionalRoutineService', () => {
  ...
  beforeEach(() => { jest.clearAllMocks(); service = new DeleteInstitutionalRoutineService(mockRepo as any, mockPrisma as any); });
