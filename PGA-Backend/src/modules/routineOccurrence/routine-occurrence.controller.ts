...
export class RoutineOccurrenceController {
  ...
  @Post()
  @ApiOperation({
    summary: 'Criar ocorrência de rotina',
    description: 'Cria uma nova ocorrência de rotina institucional',
  })
  @ApiBody({ type: CreateRoutineOccurrenceDto })
  @ApiResponse({
    status: 201,
    description: 'Ocorrência de rotina criada com sucesso',
  })
  ...
  @Get()
  @ApiOperation({
    summary: 'Listar ocorrências de rotina',
    description: 'Retorna lista de todas as ocorrências de rotina',
  })
  @ApiResponse({
    status: 200,
    description: 'Lista de ocorrências de rotina retornada com sucesso',
  })
  findAll() {
  ...
  @Get(':id')
  @ApiOperation({
    summary: 'Buscar ocorrência de rotina por ID',
    description: 'Retorna dados de uma ocorrência de rotina específica',
  })
  @ApiParam({
    name: 'id',
    type: 'number',
    description: 'ID da ocorrência de rotina',
  })
  @ApiResponse({
    status: 200,
    description: 'Ocorrência de rotina encontrada com sucesso',
  })
  @ApiResponse({
    status: 404,
    description: 'Ocorrência de rotina não encontrada',
  })
  ...
  @Put(':id')
  @ApiOperation({
    summary: 'Atualizar ocorrência de rotina',
    description: 'Atualiza dados de uma ocorrência de rotina específica',
  })
  @ApiParam({
    name: 'id',
    type: 'number',
  ...
  @ApiResponse({
    status: 200,
    description: 'Ocorrência de rotina atualizada com sucesso',
  })
  @ApiResponse({
    status: 404,
    description: 'Ocorrência de rotina não encontrada',
  ...
  @Delete(':id')
  @ApiOperation({
    summary: 'Excluir ocorrência de rotina',
    description: 'Remove uma ocorrência de rotina do sistema',
  })
  @ApiParam({
    name: 'id',
    type: 'number',
  ...
  @ApiResponse({
    status: 200,
    description: 'Ocorrência de rotina excluída com sucesso',
  })
  @ApiResponse({
    status: 404,
    description: 'Ocorrência de rotina não encontrada',
