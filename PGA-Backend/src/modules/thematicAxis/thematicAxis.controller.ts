...
export class ThematicAxisController {
  ...
  @Get()
  @ApiOperation({
    summary: 'Listar eixos temáticos',
    description: 'Retorna lista de todos os eixos temáticos',
  })
  ...
  @Get(':id')
  @ApiOperation({
    summary: 'Buscar eixo temático por ID',
    description: 'Retorna dados de um eixo temático específico',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Eixo temático atualizado com sucesso',
  })
  @ApiResponse({ status: 404, description: 'Eixo temático não encontrado' })
  ...
  @ApiResponse({
    status: 200,
    description: 'Eixo temático excluído com sucesso',
  })
  @ApiResponse({ status: 404, description: 'Eixo temático não encontrado' })
