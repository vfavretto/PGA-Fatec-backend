...
describe('CreateThematicAxisService', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    service = new CreateThematicAxisService(mockRepo as any);
  });

  it('deve criar e retornar o eixo temático', async () => {
    mockRepo.create.mockResolvedValue({ eixo_id: 'uuid-1' });
    expect(await service.execute({ nome_eixo: 'Eixo 1' } as any)).toEqual({
      eixo_id: 'uuid-1',
    });
  });
});
...
describe('FindAllThematicAxisService', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    service = new FindAllThematicAxisService(mockRepo as any);
  });
...
describe('FindOneThematicAxisService', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    service = new FindOneThematicAxisService(mockRepo as any);
  });
...
describe('UpdateThematicAxisService', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    service = new UpdateThematicAxisService(mockRepo as any);
  });
  ...
  it('deve atualizar e retornar o eixo', async () => {
    ...
    expect(
      ((await service.execute('uuid-1', { nome_eixo: 'Novo' } as any)) as any)
        .nome_eixo,
    ).toBe('Novo');
  });
...
describe('DeleteThematicAxisService', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    service = new DeleteThematicAxisService(mockRepo as any);
  });
