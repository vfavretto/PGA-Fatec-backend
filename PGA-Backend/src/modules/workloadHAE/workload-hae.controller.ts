...
export class WorkloadHaeController {
  ...
  @ApiOperation({
    summary: 'Criar carga horária HAE',
    description: 'Cria uma nova carga horária de Hora Atividade Específica',
  })
  @ApiBody({ type: CreateWorkloadHaeDto })
  @ApiResponse({
    status: 201,
    description: 'Carga horária HAE criada com sucesso',
  })
  ...
  @Get()
  @ApiOperation({
    summary: 'Listar cargas horárias HAE',
    description: 'Retorna lista de todas as cargas horárias HAE',
  })
  @ApiResponse({
    status: 200,
    description: 'Lista de cargas horárias HAE retornada com sucesso',
  })
  findAll() {
  ...
  @Get(':id')
  @ApiOperation({
    summary: 'Buscar carga horária HAE por ID',
    description: 'Retorna dados de uma carga horária HAE específica',
  })
  @ApiParam({
    name: 'id',
    type: 'number',
    description: 'ID da carga horária HAE',
  })
  @ApiResponse({
    status: 200,
    description: 'Carga horária HAE encontrada com sucesso',
  })
  ...
  @Roles('Administrador', 'CPS')
  @ApiOperation({
    summary: 'Atualizar carga horária HAE',
    description: 'Atualiza dados de uma carga horária HAE específica',
  })
  @ApiParam({
    name: 'id',
    type: 'number',
  ...
  @ApiResponse({
    status: 200,
    description: 'Carga horária HAE atualizada com sucesso',
  })
  @ApiResponse({ status: 404, description: 'Carga horária HAE não encontrada' })
  update(
  ...
  @Roles('Administrador', 'CPS')
  @ApiOperation({
    summary: 'Excluir carga horária HAE',
    description: 'Remove uma carga horária HAE do sistema',
  })
  @ApiParam({
    name: 'id',
    type: 'number',
  ...
  @ApiResponse({
    status: 200,
    description: 'Carga horária HAE excluída com sucesso',
  })
  @ApiResponse({ status: 404, description: 'Carga horária HAE não encontrada' })
