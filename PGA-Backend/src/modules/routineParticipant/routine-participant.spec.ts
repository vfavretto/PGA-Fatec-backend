...
describe('CreateRoutineParticipantService', () => {
  ...
  beforeEach(() => { jest.clearAllMocks(); service = new CreateRoutineParticipantService(mockRepo as any); });

  it('deve criar e retornar o participante', async () => {
    mockRepo.create.mockResolvedValue({ participant_id: 1 });
    expect(await service.execute({ nome: 'João' } as any)).toEqual({ participant_id: 1 });
  });
});

describe('FindAllRoutineParticipantService', () => {
  let service: FindAllRoutineParticipantService;
  beforeEach(() => { jest.clearAllMocks(); service = new FindAllRoutineParticipantService(mockRepo as any); });
...
describe('FindOneRoutineParticipantService', () => {
  ...
  beforeEach(() => { jest.clearAllMocks(); service = new FindOneRoutineParticipantService(mockRepo as any); });
...
describe('UpdateRoutineParticipantService', () => {
  ...
  beforeEach(() => { jest.clearAllMocks(); service = new UpdateRoutineParticipantService(mockRepo as any); });
...
describe('DeleteRoutineParticipantService', () => {
  ...
  beforeEach(() => { jest.clearAllMocks(); service = new DeleteRoutineParticipantService(mockRepo as any); });
