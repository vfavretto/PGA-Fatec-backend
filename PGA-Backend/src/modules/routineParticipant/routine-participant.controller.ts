...
export class RoutineParticipantController {
  ...
  @Post()
  @ApiOperation({
    summary: 'Adicionar participante à rotina',
    description: 'Adiciona um participante a uma rotina institucional',
  })
  ...
  @Get()
  @ApiOperation({
    summary: 'Listar participantes de rotinas',
    description: 'Retorna lista de todos os participantes de rotinas',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description: 'Retorna dados de um participante específico',
  })
  ...
  @ApiOperation({
    ...
    description: 'Atualiza dados de um participante específico',
  })
  @ApiParam({ name: 'id', type: 'number', description: 'ID do participante' })
  ...
  @ApiOperation({
    ...
    description: 'Remove um participante de uma rotina',
  })
  @ApiParam({ name: 'id', type: 'number', description: 'ID do participante' })
  @ApiResponse({
    status: 200,
