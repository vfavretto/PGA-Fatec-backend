...
describe('CreateUserService', () => {
  ...
  it('deve lançar ForbiddenException se sem reqUser e total > 0', async () => {
    ...
    await expect(
      service.execute({ tipo_usuario: 'Docente' } as any, null),
  ...
  it('deve lançar BadRequestException se Diretor sem unidade_id', async () => {
    ...
    await expect(
      service.execute(
        { tipo_usuario: 'Docente' } as any,
        { tipo_usuario: 'Diretor', pessoa_id: 1 } as any,
      ),
  ...
  it('deve lançar ForbiddenException se Diretor tentar criar fora da unidade', async () => {
    ...
    await expect(
      service.execute(
        { tipo_usuario: 'Docente', unidade_id: 99 } as any,
        { tipo_usuario: 'Diretor', pessoa_id: 1 } as any,
      ),
    ).rejects.toThrow(ForbiddenException);
  });
  ...
  it('deve lançar ForbiddenException se Diretor tentar criar Administrador', async () => {
    ...
    await expect(
      service.execute(
        { tipo_usuario: 'Administrador', unidade_id: 5 } as any,
        { tipo_usuario: 'Diretor', pessoa_id: 1 } as any,
      ),
    ).rejects.toThrow(ForbiddenException);
  });
  ...
  it('deve criar usuário com senha se fornecida', async () => {
    ...
    const result = await service.execute(
      { tipo_usuario: 'Docente', unidade_id: 1, senha: 'pass123' } as any,
      { tipo_usuario: 'Administrador' } as any,
    );
